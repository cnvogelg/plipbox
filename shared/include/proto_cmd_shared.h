...
// mode
#define PROTO_CMD_MODE_ATTACH     0x30 // read word - result
#define PROTO_CMD_MODE_DETACH     0x31 // read word - result
#define PROTO_CMD_MODE_SET        0x32 // write_word
#define PROTO_CMD_MODE_GET        0x33 // read_word

// status
#define PROTO_CMD_EVENT_MASK      0x40 // read_word
#define PROTO_CMD_MODE_STATUS     0x41 // read_word
#define PROTO_CMD_NIC_STATUS      0x42 // read_word
