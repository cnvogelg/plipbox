...
u08 nic_rx_size(u16 *size)
{
  return nic_mod_rx_size(size);
}
...
u08 nic_rx_direct_begin(void)
{
  return nic_mod_rx_direct_begin();
}

u08 nic_rx_direct_end(void)
{
  return nic_mod_rx_direct_end();
}
...
u08 nic_tx_direct_end(void)
{
  return nic_mod_tx_direct_end();
}
